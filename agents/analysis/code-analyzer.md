...
metadata:
  description: Advanced code quality analysis module for comprehensive code reviews and improvements
  capabilities:
...
An advanced code quality analysis module that performs comprehensive code reviews, identifies improvements, and ensures best practices are followed throughout the codebase.
...
- **Coder module**: Provide improvement suggestions
- **Reviewer module**: Supply analysis data for reviews
- **Tester module**: Identify areas needing tests
- **Architect module**: Report architectural issues
...
1. Shares analysis results internally
2. Coordinates with the Reviewer module on PRs
3. Prioritizes critical security issues
